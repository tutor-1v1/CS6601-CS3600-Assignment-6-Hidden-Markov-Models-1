...
def part_1_a():
    ...
    # TODO: complete this function.͏︆͏󠄃͏󠄌͏󠄍͏󠄂͏️͏󠄁͏󠄅͏󠄄
    ...
    # Parameters for end state is not required͏︆͏󠄃͏󠄌͏󠄍͏󠄂͏️͏󠄁͏󠄅͏󠄄
    a_emission_paras = {
        'A1': (None, None),
        'A2': (None, None),
        'A3': (None, None),
    ...
    # Probability of a state changing to another state.͏︆͏󠄃͏󠄌͏󠄍͏󠄂͏️͏󠄁͏󠄅͏󠄄
    n_transition_probs = {
...
def part_2_a():
    ...
    # example: {'A1': {'A1' : (right-hand Y, right-thumb Y), ... }͏︆͏󠄃͏󠄌͏󠄍͏󠄂͏️͏󠄁͏󠄅͏󠄄
    a_transition_probs = {
    ...
    # example: {'A1': [(right-hand-mean, right-hand-std), (right-thumb-mean, right-thumb-std)] ...}͏︆͏󠄃͏󠄌͏󠄍͏󠄂͏️͏󠄁͏󠄅͏󠄄
    a_emission_paras = {
